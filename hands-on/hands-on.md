...
```
The bed and the wig files correspond respectively to the list of peaks positions in the genome and their signal intensities. They can be both generated by runing macs in a single command line using -w -S options.
